...
const { REACT_APP_HAWKINS_URL, REACT_APP_HAWKINS_TIMEOUT,
  ...
  REACT_APP_UPSIDEDOWN_TIMEOUT, REACT_APP_DEV_MODE } = process.env;
...
class StrangerThings extends React.Component {
  ...
  render() {
    const {
      hereIsTheUpsideDownWorld, characterName, characters, page, devMode,
    } = this.state;
    return (
      <div
      ...
      >
        { devMode === 'true' ? <h2>Em desenvolvimento</h2> : false }
